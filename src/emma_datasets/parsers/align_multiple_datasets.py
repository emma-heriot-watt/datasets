...
class AlignMultipleDatasets:
    ...
    def __call__(
        self,
        *aligned_metadata_iterable: DatasetAlignerReturn,
        ...
        common_instances = self.get_all_common_instances(all_common_dataset_mapping, aligned_ids)
        non_common_instances = self.get_all_non_common_instances(
            all_common_dataset_mapping, aligned_ids
        )
        non_aligned_instances = self.get_all_non_alignable_instances(aligned_metadata_iterable)
