...
class BaseAugmentation(abc.ABC):
    ...
    def __init__(
        self, root_vision_path: Path, report_path: Path, diverse_image_selector: CLIProcessor
    ) -> None:
        ...
        self._object_to_special_object_map = {
    ...
    def post_process_metadata(
        self, action_type_metadata: dict[str, Any], class_thresholds: dict[str, list[int]]
    ) -> dict[str, Any]:
