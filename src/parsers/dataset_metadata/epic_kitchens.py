...
from src.parsers.dataset_metadata.metadata_parser import DataPathTuple, DatasetMetadataParser
...
class EpicKitchensMetadataParser(DatasetMetadataParser[EpicKitchensNarrationMetadata]):
    ...
    def convert_to_dataset_metadata(
        ...
        return DatasetMetadata(
            ...
            caption_path=self.captions_dir.joinpath(f"{metadata.narration_id}.json").as_posix(),
        )
